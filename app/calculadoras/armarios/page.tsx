...
async function getCalculos(): Promise<SavedCalculoArmario[]> {
  ...
  return calculos.map((calculo) => ({
    ...
    precioTableroM2: toNumber(calculo.precioTableroM2),
    precioTraseraM2: toNumber(calculo.precioTraseraM2),
    precioCantoMl: toNumber(calculo.precioCantoMl),
    precioBisagraUnidad: toNumber(calculo.precioBisagraUnidad),
    precioGuiaCajonJuego: toNumber(calculo.precioGuiaCajonJuego),
    precioBarraMl: toNumber(calculo.precioBarraMl),
    precioSoporteBarraUnidad: toNumber(calculo.precioSoporteBarraUnidad),
    costeHoraTaller: toNumber(calculo.costeHoraTaller),
    horasTaller: toNumber(calculo.horasTaller),
    costeHoraMontaje: toNumber(calculo.costeHoraMontaje),
    horasMontaje: toNumber(calculo.horasMontaje),
    margenComercial: toNumber(calculo.margenComercial),
    precioJuanserM2: toNumber(calculo.precioJuanserM2),
